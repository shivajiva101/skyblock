...
function skyblock.levels.get_inventory_formspec(level,player_name,inventory)
	...
	if inventory then
		...
		formspec = formspec..'button_exit[13,0.9;2,0.5;close;Close]'
	else
		formspec = formspec
	...
	formspec = formspec
		...
		..'label[7,1.6; Rewards]'
		..'background[6.9,1.6;2.2,2.8;rewards.png]'
		..'list[current_player;rewards;7,2.1;2,2;]'

		..'label[10.1,1.6; Craft]'
		..'label[13.5,2.5;Output]'
		..'background[9.9,1.6;5.2,3.8;craft.png]'
		..'list[current_player;craft;10.2,2.1;3,3;]'
		..'list[current_player;craftpreview;13.5,3.1;1,1;]'

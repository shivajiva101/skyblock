...
skyblock.levels[level].get_info = function(player_name)
	...
	local text = 'label[0,2.7; --== Quests ==--]'
		..'label[0,0.5; Well '..player_name..', your quite good at this!]'
		..'label[0,1.0; Stay on the path for great rewards...]'
		..'label[0,1.5; ...your endeavours are bringing it within]'
		..'label[0,2.0; your reach!]'

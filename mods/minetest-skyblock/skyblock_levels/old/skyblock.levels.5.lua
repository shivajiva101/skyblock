...
skyblock.levels[level].init = function(player_name)
	...
	minetest.chat_send_player(player_name, 'You can now use the skins button to change your appearance!')
end
...
skyblock.levels[level].get_info = function(player_name)
	...
	local text = 'label[0,0.5; THE END]'
		...
		..'label[0,2.0; your new sky world and making friends.]'
	...
	info.infotext = 'THE player '.. player_name ..' completed all the quests!'
	return info
end
